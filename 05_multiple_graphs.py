...
app.layout = html.Div([
    ...
    html.Div(dcc.Graph(id='graph-with-slider'), style={'width': '49%', 'display': 'inline-block', 'padding': '0 20'}),
    html.Div(dcc.Graph(id='summary-graph'), style={'width': '49%', 'display': 'inline-block'}),
    html.Div(dcc.Slider(
        id='year-slider',
        min=df['year'].min(),
        max=df['year'].max(),
